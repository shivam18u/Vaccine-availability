...
url='https://cdn-api.co-vin.in//api/v2/appointment/sessions/public/calendarByDistrict?district_id=366&date=06-05-2021'   ### date and district code
    ...
    for i in x['centers']:
        for j in i['sessions']:
            if (j['available_capacity']>0):
                ...
                unavailable=False
                os.startfile('E:\\MUSIC\\RISE I Worlds 2018 - League of Legends.mp3')    ### Make sure you use \\ for defining path in windows
                break
    time.sleep(2)
    print('running....')
